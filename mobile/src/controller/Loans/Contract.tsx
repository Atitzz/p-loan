...
function Contract() {
  ...
  useEffect(() => {
    Get(`loan/list/all?search=${loan_number}`).then((resoinse) => {
      setLoan(resoinse.data.data[0]);
    });
  }, [loan_number]);
  useEffect(() => {
    Print()
  ...
  const Print = async () => {
    const element = toPage1.current;
    const canvas = await html2canvas(element);
    const imgData = canvas.toDataURL("image/png", 1.0);
    // แปลง Base64 DataURL เป็น Blob
  ...
  return (
    <>
          ...
          <Stack gap={1} sx={{ m: 5, color: "#000" }}>
            ...
            <Stack direction="row" gap={4}>
              <Stack direction="row" sx={{ flex: 2, gap: 1 }}>
                <Typography variant="body1">เลขที่สัญญา</Typography>
                <Typography
                  variant="body1"
              ...
              <Stack direction="row" sx={{ flex: 2, gap: 1 }}>
                <Typography variant="body1">ทำที่ </Typography>
                <Typography
                  variant="body1"
                  sx={{ borderBottom: "1px solid #000000", flex: 1 }}
                >
            ...
            <Stack direction="row" gap={4}>
              ...
              <Stack direction="row" sx={{ flex: 2, gap: 1 }}>
                ...
                <Typography
                  ...
                  sx={{ borderBottom: "1px solid #000000", flex: 1 }}
                >
                  {toDate(loan?.approved_at || "", 1)}
                </Typography>
              </Stack>
            </Stack>
            <Stack direction="row" gap={2}>
              <Stack direction="row" sx={{ flex: 1, gap: 1 }}>
                <Typography variant="body1" sx={{ pl: 15 }}>
                  ข้าพเจ้า
                </Typography>
                <Typography
                  variant="body1"
            ...
            <Stack direction="row" gap={2}>
              <Stack direction="row" sx={{ gap: 1 }}>
                ...
                <Typography
                  ...
                  sx={{ borderBottom: "1px solid #000000", flex: 1 }}
                >
                  {`${calcurateAge(auth.birthdate)} ปี`}
                </Typography>
              </Stack>
              <Stack direction="row" sx={{ gap: 1 }}>
                <Typography variant="body1">
              ...
              <Stack direction="row" sx={{ gap: 1 }}>
                <Typography variant="body1">หมู่ที่</Typography>
                <Typography
                  variant="body1"
                  sx={{ borderBottom: "1px solid #000000", flex: 1 }}
                >
              ...
              <Stack direction="row" sx={{ gap: 1 }}>
                <Typography variant="body1">ตรอก/ซอย</Typography>
                <Typography
                  variant="body1"
                  sx={{ borderBottom: "1px solid #000000", flex: 1 }}
                >
              ...
              <Stack direction="row" sx={{ flex: 1, gap: 1 }}>
                <Typography variant="body1">ถนน</Typography>
                <Typography
                  variant="body1"
                  sx={{ borderBottom: "1px solid #000000", flex: 1 }}
                >
            ...
            <Stack direction="row" gap={2}>
              <Stack direction="row" sx={{ flex: 1, gap: 1 }}>
                <Typography variant="body1">ตำบล/แขวง</Typography>
                <Typography
                  variant="body1"
                  sx={{ borderBottom: "1px solid #000000", flex: 1 }}
                >
              ...
              <Stack direction="row" sx={{ flex: 1, gap: 1 }}>
                <Typography variant="body1">อำเภอ/เขต</Typography>
                <Typography
                  variant="body1"
                  sx={{ borderBottom: "1px solid #000000", flex: 1 }}
                >
              ...
              <Stack direction="row" sx={{ flex: 1, gap: 1 }}>
                <Typography variant="body1">จังหวัด</Typography>
                <Typography
                  variant="body1"
                  sx={{ borderBottom: "1px solid #000000", flex: 1 }}
                >
            ...
            <Stack direction="row" gap={2}>
              <Stack direction="row" sx={{ flex: 1, gap: 1 }}>
                ...
                <Typography
                  ...
                  sx={{ borderBottom: "1px solid #000000", flex: 1 }}
                >
                   {auth.job_company_name}
                </Typography>
              </Stack>
              <Stack direction="row" sx={{ gap: 1 }}>
                <Typography variant="body1">เลขที่</Typography>
                <Typography
                  variant="body1"
                  sx={{ borderBottom: "1px solid #000000", flex: 1 }}
                >
            ...
            <Stack direction="row" gap={2}>
              <Stack direction="row" sx={{ flex: 1, gap: 1 }}>
                <Typography variant="body1">มีสถานประกอบการอยู่ที่</Typography>
                <Typography
                  variant="body1"
                  sx={{ borderBottom: "1px solid #000000", flex: 1 }}
                >
            ...
            <ol style={{ margin: 0, listStyle: "none", paddingLeft: "2em" }}>
                ...
                <Stack direction="row" gap={2}>
                  <Stack direction="row" sx={{ flex: 1, gap: 1 }}>
                    <Typography variant="body1" sx={{ textAlign: "justify"}}>
                      ...
                      ในอัตราดอกเบี้ยไม่เกินร้อยละ 36 ต่อปี แบบ{loan?.type_interest === "flatrate" ? "คงที่" : "ลดต้นลดดอก"}
              ...
              <li>
                ...
                <Stack direction="row" gap={2}>
                  <Stack direction="row" sx={{ flex: 1, gap: 1 }}>
                    ...
                    <Typography
                      ...
                      sx={{ borderBottom: "1px solid #000000" }}
                    >
                      {toFloat(loan?.per_installment || 0)} บาท
                    </Typography>
                    <Typography
                      variant="body1"
                      sx={{ borderBottom: "1px solid #000000" }}
                    >
                      ({NumberToThaiWords(loan?.per_installment || 0)})
                    </Typography>
                  </Stack>
                </Stack>
                <Stack direction="row" gap={2}>
                  <Stack direction="row" sx={{ flex: 1, gap: 1 }}>
                    <Typography variant="body1">เป็นระยะเวลา</Typography>
                    <Typography
                      variant="body1"
                      sx={{ borderBottom: "1px solid #000000" }}
                    >
                      {loan?.total_installment || 0} งวดเดือน
                    </Typography>
                    <Typography variant="body1">นับตั้งแต่งวดวันที่</Typography>
                    <Typography
                      variant="body1"
                      sx={{ borderBottom: "1px solid #000000" }}
                    >
                      {toDate(loan?.startDate, 1)}
                    </Typography>
                    <Typography variant="body1">
                ...
                <Stack direction="row" gap={2}>
                  <Stack direction="row" sx={{ flex: 1, gap: 1 }}>
                    <Typography variant="body1">ภายในวันที่</Typography>
                    <Typography
                      variant="body1"
                      sx={{ borderBottom: "1px solid #000000" }}
                    >
                      {toDate(loan?.endDate, 1)}
                    </Typography>
                    <Typography variant="body1">
            ...
            <ol style={{ margin: 0, listStyle: "none", paddingLeft: "2em" }}>
              ...
              <li>
                <Stack direction="row" alignItems="flex-start">
                  ...
                  <Typography
                    variant="body1"
                    sx={{ textAlign: 'justify', marginLeft: '5px', flex: 1 }}
                  >
              ...
              <li>
                <Stack direction="row" alignItems="flex-start">
                  ...
                  >
                    ...
                    โดยผู้กู้ตกลงยินยอมให้ผู้ให้กู้คิดค่าธรรมเนียมผิดนัดชำระหนี้
                    และ/หรือ ค่าใช้จ่ายในการติดตามทวงถามหนี้ ทั้งนี้
                    นับตั้งแต่วันผิดนัดเป็นต้นไป จนกว่าจะชำระหนี้คืนให้แก้ผู้ให้กู้เสร็จสิ้น
            ...
            {/* <li>
                  ...
                  <li>
                    <Typography variant="body1">
                      ...
                      ซึ่งมีอยู่กับบริษัทข้อมูลเครดิตดังกล่าวได้ตลอดอายุของสัญญาฉบับนี้
                  ...
                  <li>
                    <Stack direction="row" alignItems="flex-start">
                      ...
                      >
                        ...
                        และ/หรือข้อมูลอื่นใดของผู้กู้ ซึ่งมีอยู่กับบริษัทข้อมูลเครดิตดังกล่าวได้ตลอดอายุของสัญญาฉบับนี้
                        ทั้งนี้การดำเนินการเกี่ยวกับข้อมูลเครดิตดังกล่าวจะต้องเป็นไปตามวัตถุประสงค์ของการใช้ข้อมูลเพื่อประโยชน์ในการวิเคราะห์สินเชื่อของผู้กู้ที่ให้ไว้กับผู้ให้กู้
      ...
      <Box sx={{ width: "100%", height: "300px" }}>.</Box>
    </>
  );
}
