...
function ReportRemaining() {
  ...
  useEffect(() => {
    setIsLoading(true);
    Get(`loan/running?search=${search}&page=${page}&limit=${pageSize}&start=${searchDate.start}&end=${searchDate.end}`)
      .then((response) => {
  ...
  const columns: GridColDef<(typeof data)[number]>[] = [
    ...
    },
    {
      ...
      headerName: `${useLang("ค้างดอกเบี้ย", "Interest")}`,
      headerAlign: "center",
      align: "center",
      flex: 1,
    ...
    },
    {
      ...
      headerName: `${useLang("รวมหนี้คงเหลือ", "Total Remaining")} `,
      headerAlign: "center",
      align: "center",
      flex: 1,
      valueFormatter: (value) => `${toFloat(value)}`,
        ...
        <Stack>
          <Stack ref={contentToPrint}>
            ...
            <Stack direction='row' justifyContent='space-between'>
              ...
              <Typography variant="body2">
                <strong>รายงาน ลูกหนี้คงเหลือ</strong>
              </Typography>
              </Stack>
              <Typography variant="body2">
              ...
              >
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell align="center">ค้างดอกเบี้ย</TableCell>
                    <TableCell align="center">รวมหนี้คงเหลือ</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell align="center">
                      {toFloat(total.overdue_balance)}
                    </TableCell>
                    <TableCell align="center">
                      {toFloat(total.total_remaining)}
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
...
export default ReportRemaining
