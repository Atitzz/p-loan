    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                whereClause = {};
                if (search) {
                    whereClause.table = (0, typeorm_1.Like)("%".concat(search, "%"));
                }
                if (start && end) {
                ...
                return [4 /*yield*/, (0, data_source_1.orm)(entities_1.System_Logs).count({ where: whereClause })];
            case 1:
                _total = _b.sent();
                return [4 /*yield*/, (0, data_source_1.orm)(entities_1.System_Logs).find({
                        where: whereClause,
                        order: { id: "DESC" },
                        take: perPage,
                        skip: offset,
