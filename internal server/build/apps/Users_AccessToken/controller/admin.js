    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, data_source_1.orm)(entities_1.UsersAccessToken).count({ where: whereClause })];
            case 1:
                _total = _b.sent();
                return [4 /*yield*/, (0, data_source_1.orm)(entities_1.UsersAccessToken).find({
                        where: whereClause,
                        take: perPage,
                        skip: offset,
                    })];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, data_source_1.orm)(entities_1.UsersAccessToken).findOne({
                        where: {
                            id: id,
                        },
                    })];
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, (0, data_source_1.orm)(entities_1.UsersAccessToken).softDelete(data.id)];
            case 3:
                _a.sent();
