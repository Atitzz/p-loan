...
var CronSchedule = /** @class */ (function (_super) {
    __extends(CronSchedule, _super);
    ...
    ], CronSchedule.prototype, "name", void 0);
    __decorate([
        (0, typeorm_1.Column)({ type: 'int', default: 0 }),
        __metadata("design:type", Number)
    ], CronSchedule.prototype, "interval", void 0);
    __decorate([
        (0, typeorm_1.Column)({ type: 'enum', enum: enum_1.status, default: enum_1.status.Enable }),
        __metadata("design:type", String)
    ], CronSchedule.prototype, "status", void 0);
    CronSchedule = __decorate([
        (0, typeorm_1.Entity)('cron_schedules')
    ], CronSchedule);
    return CronSchedule;
