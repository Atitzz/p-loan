...
exports.list = exports.update = exports.store = void 0;
...
var store = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, id, username, password, permission, roles, created_at, updated_at, deleted_at, obj, Keys, data, result, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                data = new loan_contract_1.LoanContractNonUser();
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                __1.io.emit('loan_apply_now', { action: 1 });
                return [4 /*yield*/, (0, data_source_1.orm)(loan_contract_1.LoanContractNonUser).save(data)];
            case 2:
                result = _b.sent();
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, id, username, password, permission, roles, created_at, updated_at, deleted_at, obj, data, result, err_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, id = _a.id, username = _a.username, password = _a.password, permission = _a.permission, roles = _a.roles, created_at = _a.created_at, updated_at = _a.updated_at, deleted_at = _a.deleted_at, obj = __rest(_a, ["id", "username", "password", "permission", "roles", "created_at", "updated_at", "deleted_at"]);
                return [4 /*yield*/, (0, data_source_1.orm)(loan_contract_1.LoanContractNonUser).findOne({ where: { id: id } })];
            case 1:
                data = _b.sent();
                if (!data)
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, data_source_1.orm)(loan_contract_1.LoanContractNonUser).count({ where: whereClause })];
            case 1:
                _total = _b.sent();
                return [4 /*yield*/, (0, data_source_1.orm)(loan_contract_1.LoanContractNonUser).find({
                        where: whereClause,
                        take: perPage,
                        skip: offset,
