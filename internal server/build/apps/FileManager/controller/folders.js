...
exports.remove = exports.list = exports.update = exports.store = void 0;
var typeorm_1 = require("typeorm");
var data_source_1 = require("../../../data-source");
var Folder_Manager_1 = require("../entities/Folder_Manager");
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                data = new Folder_Manager_1.Folder_Manager();
            ...
            case 1:
                _b.trys.push([1, 4, , 5]);
                return [4 /*yield*/, data.createLog(req, "store", "Roles", obj)];
            case 2:
                _b.sent();
                return [4 /*yield*/, (0, data_source_1.orm)(Folder_Manager_1.Folder_Manager).save(data)];
            case 3:
                result = _b.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, data_source_1.orm)(Folder_Manager_1.Folder_Manager).findOne({
                        where: {
                            id: id,
                        },
                    })];
            ...
            case 2:
                _b.trys.push([2, 5, , 6]);
                return [4 /*yield*/, data.createLog(req, "update", "Roles", obj)];
            case 3:
                _b.sent();
                return [4 /*yield*/, (0, data_source_1.orm)(Folder_Manager_1.Folder_Manager).save(data)];
            case 4:
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, data_source_1.orm)(Folder_Manager_1.Folder_Manager).count({ where: whereClause })];
            case 1:
                _total = _b.sent();
                return [4 /*yield*/, (0, data_source_1.orm)(Folder_Manager_1.Folder_Manager).find({
                        where: whereClause,
                        take: perPage,
                        skip: offset,
                    })];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!data)
                    return [2 /*return*/, res.error("404 not found")];
                return [4 /*yield*/, data.createLog(req, "remove", "Roles", data)];
            case 2:
                _a.sent();
                return [4 /*yield*/, (0, data_source_1.orm)(Folder_Manager_1.Folder_Manager).delete(id)];
            case 3:
                _a.sent();
