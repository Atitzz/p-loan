...
var store = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                _b.sent();
                return [4 /*yield*/, (0, data_source_1.orm)(entities_1.Roles).save(data)];
            case 3:
                result = _b.sent();
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var pid, _a, id, created_at, updated_at, deleted_at, obj, data, Keys, result, err_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                pid = req.params.pid;
                ...
                return [4 /*yield*/, (0, data_source_1.orm)(entities_1.Roles).findOne({
                        where: {
                            id: pid,
                        },
                    })];
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, data_source_1.orm)(entities_1.Roles).count({ where: whereClause })];
            case 1:
                _total = _b.sent();
                return [4 /*yield*/, (0, data_source_1.orm)(entities_1.Roles).find({
                        where: whereClause,
                        take: perPage,
                        skip: offset,
                    })];
...
var remove = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, (0, data_source_1.orm)(entities_1.Roles).delete(id)];
            case 3:
                _a.sent();
