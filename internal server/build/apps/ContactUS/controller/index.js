...
var contactus_1 = require("../entities/contactus");
var __1 = require("../../..");
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                data = new contactus_1.ContactUS();
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                __1.io.emit('contact_us', { action: 1 });
                return [4 /*yield*/, (0, data_source_1.orm)(contactus_1.ContactUS).save(data)];
            case 2:
                result = _b.sent();
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, id = _a.id, username = _a.username, password = _a.password, permission = _a.permission, roles = _a.roles, created_at = _a.created_at, updated_at = _a.updated_at, deleted_at = _a.deleted_at, obj = __rest(_a, ["id", "username", "password", "permission", "roles", "created_at", "updated_at", "deleted_at"]);
                return [4 /*yield*/, (0, data_source_1.orm)(contactus_1.ContactUS).findOne({ where: { id: id } })];
            case 1:
                data = _b.sent();
                if (!data)
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, data_source_1.orm)(contactus_1.ContactUS).count({ where: whereClause })];
            case 1:
                _total = _b.sent();
                return [4 /*yield*/, (0, data_source_1.orm)(contactus_1.ContactUS).find({
                        where: whereClause,
                        take: perPage,
                        skip: offset,
